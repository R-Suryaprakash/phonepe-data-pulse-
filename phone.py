...
if select == "HOME":
    ...
    with col2:
        st.image(Image.open(r"C:\Users\surya\OneDrive\Desktop\suryavs\images.png"),width= 400)

    col3,col4= st.columns(2)
    
    with col3:
        st.image(Image.open(r"C:\Users\surya\OneDrive\Desktop\suryavs\db4253052cfc0f80ac281486c19f9d57.png"),width=400)
    ...
    with col6:
        st.image(Image.open(r"C:\Users\surya\OneDrive\Desktop\suryavs\images.jpg"),width= 400)
